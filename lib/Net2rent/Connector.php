...
class Connector 
{
    ...
    {
        $endPoint = (isset($options['checkin'])) ? '/portals/%s/typologies_availability' : '/portals/%s/typologies';
        ...
        foreach($typologies as $typology) {
            ...
            $equipments = array();
            $not_equipments = array('id', 'typology_id', 'creation_date', 'creation_usr', 'edition_date', 'edition_usr');
    ...
    {
        $endPoint = (isset($options['checkin'])) ? '/portals/%s/typologies_availability/%s' : '/portals/%s/typologies/%s';
        ...
        $typology0 = $this->api(sprintf($endPoint.'?%s', $this->apiUser, $property_id, http_build_query($params)));
